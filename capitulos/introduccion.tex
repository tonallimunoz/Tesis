...
El aerosol atmosférico está formado de partículas suspendidas en la atmósfera, ya sean sólidas o líquidas con una composición química distinta del agua \citep{Boucher}.
...
LED & LED & 2700 - 5000 & 10 - 150 (baja a muy alta) \\ \hline
\end{tabular}%
}
\end{table}
...
Considerando que el factor de consumo de energía eléctrica en 2017 fue 0.582 toneladas de CO$_{2}$ equivalente por MWh \citep{CRE2017}, se tiene que en 2017 se emitieron 7,318,993 toneladas de CO$_{2}$ por consumo de energía eléctrica en la Ciudad de México (6\% del total de las emisiones nacionales de CO$_{2}$ por consumo de energía eléctrica).\\
